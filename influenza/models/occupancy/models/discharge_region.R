...
#'
#' @title
#' Influenza occupancy via discharge posteriors
#'
#' @description
#' Use discharge posteriors to create influenza occupancy forecast
#'
#' @details
#' # Development
#'
...
#' Use regional discharge posteriors to create influenza occupancy forecast
#'
...
run_discharge_region <- function(training_data, overall_params) {
  ...
  parameters <- draws |>
    tidyr::pivot_longer(cols = dplyr::starts_with("lognormal_mu"),
      names_to = "r_lognormal_mu", values_to = "lognormal_mu") |>

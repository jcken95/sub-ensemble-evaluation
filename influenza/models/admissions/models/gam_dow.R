...
#'
#' @title
#' Baseline influenza admissions GAM (day of week effect)
#'
#' @description
#' Generalised additive model (day of week effect) for influenza admissions forecasting.
...
#' # Development
#'
#' Model first developed in Winter 24/25 to with the aim of providing a baseline model for forecasting influenza
#' hospital admissions.
#'
#' # Key assumptions
#'
...
#' Run influenza admissions GAM (day of week) model
#'
#' Fit an additive model to influenza admissions data, and format the outputs.
#' Run `box::help(gam_dow)` for modelling details.
#'
...
#'   containing model output and predictions, and `models` is the model object.
#'
#' @export

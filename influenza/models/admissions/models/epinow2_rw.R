...
#'
#' @title
#' Influenza admissions EpiNow2 Random Walk model
#'
#' @description
#' EpiNow2 Random Walk model for Influenza admissions forecasting.
...
#'
#' - Incubation period:
#'  https://www.sciencedirect.com/science/article/pii/S1567134818306051
#'  we need to use a mix of A & B (A longer, B shorter)
#'  A: 1.4 days (95% CI 1.3–1.5)
#'  B: 0.6 days (95% CI 0·5–0·6)
#'  Lets go for 1.2 as A dominates
#' - Onset to hospitalisation:
#' Non-data driven (using prior evidence and similar other diseases) until epi parameters found.
#' - Generation time:
#' https://pmc.ncbi.nlm.nih.gov/articles/PMC11370535/#:~:text=We%20estimated%20a%20mean%20intrinsic,%3A%202.7%E2%80%933.0)%20days.# nolint
#' 3.2 (95% credible interval, CrI: 2.9–3.6)
#' - Infection hospitalisation risk:
#' Assumed as 0.8% based on crude_ihr.R script using respiratory pilot data and 2022/23 hospitalisations.
#'
#'
...
#'
#' This scaling factor is challenging to parameterise. We tuned the value somewhere between 0.1 and 0.3
#'
#' # Other documentation
#'
...
run_epinow2_rw <- function(
  ...
  # an average of the population by location, used for cases of missing populations

...
#'
#' @title
#' Influenza admissions example model
#'
#' @description
#' Example model for influenza admissions forecasting
#'
#' @details
#' # Development
#'
...
#' Run influenza admissions example model
#'
...
run_example <- function(
  ...
  # maintain informative name internally
